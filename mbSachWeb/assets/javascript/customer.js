...
function handlerSearchCus() {
    ...
    let url = CustomerAPI + "/search/" + value;
    SearchCus(data, url, () => {
...
function renderCustomer(customers) {
    ...
    var htmls = customers.map(function (customer) {
        return `<tr class='CustomerID-${customer.CustomerID}'>
                    ...
                    <td class="CusPhone">${customer.Phone}</td>
                    <td>
...
function handlerAddCus() {
    ...
    let formPhone = document.querySelector("#cusPhone");
    formName.value = formPhone.value = "";
    addNew.onclick = (e) => {
        e.preventDefault()
        let Name = document.querySelector("#cusName").value;
        let Phone = document.querySelector("#cusPhone").value;
        let data =
        {
            Name,
            Phone
...
function handlerEditCus(id) {
    ...
    let Phone = block.querySelector(".CusPhone").innerText;
